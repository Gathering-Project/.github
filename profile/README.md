...
간편하게 소모임을 생성하고 활발한 커뮤니티를 형성할 수 있도록 직관적인 사용자 경험과 신뢰 기반의 환경을 제공합니다.
...
### 2. 검색 고도화 및 성능 최적화
   ...
   - 소모임 제목, 지역 기반 복합 검색을 통해 사용자 만족도 향상
### 3. 실시간 알림 시스템 구현
...
![인프라 추가 설명 블로그](https://minjooig.tistory.com/173)
...
* **ElasticSearch 기반 검색 기능**
    ...
    - [x] 데이터에서 특정 문구를 포함하는 데이터 찾기를 제공
